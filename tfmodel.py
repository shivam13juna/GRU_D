...
class GRUD():
    def __init__(self, input_size, hidden_size, output_size,
        ...
        self.W_r = tf.get_variable(dtype = tf.float32, shape = [input_size, hidden_size], initializer= tf.initializers.random_normal(0, 0.02) )
        self.U_r = tf.get_variable(dtype = tf.float32, shape = [hidden_size, hidden_size], initializer= tf.initializers.random_normal(0, 0.02) )
        self.V_r = tf.get_variable(dtype = tf.float32, shape = [input_size, hidden_size], initializer= tf.initializers.random_normal(0, 0.02) )
        self.b_r = tf.get_variable(dtype = tf.float32, shape = [hidden_size], initializer=tf.keras.initializers.Zeros())

        self.W_z = tf.get_variable(dtype = tf.float32, shape = [input_size, hidden_size], initializer= tf.initializers.random_normal(0, 0.02) )
        self.U_z = tf.get_variable(dtype = tf.float32, shape = [hidden_size, hidden_size], initializer= tf.initializers.random_normal(0, 0.02) )
        self.V_z = tf.get_variable(dtype = tf.float32, shape = [input_size, hidden_size], initializer= tf.initializers.random_normal(0, 0.02) )
        self.b_z = tf.get_variable(dtype = tf.float32, shape = [hidden_size], initializer= tf.keras.initializers.Zeros())

        self.W = tf.get_variable(dtype = tf.float32, shape = [input_size, hidden_size], initializer= tf.initializers.random_normal(0, 0.02) )
        self.U = tf.get_variable(dtype = tf.float32, shape = [hidden_size, hidden_size], initializer= tf.initializers.random_normal(0, 0.02) )
        self.V = tf.get_variable(dtype = tf.float32, shape = [input_size, hidden_size], initializer= tf.initializers.random_normal(0, 0.02) )
        self.b = tf.get_variable(dtype = tf.float32, shape = [hidden_size], initializer = tf.keras.initializers.Zeros())

        # since W_gamma_x is diagonal, just initialize 1-d
        self.W_gamma_x = tf.get_variable(dtype = tf.float32, shape = [input_size], initializer= tf.keras.initializers.Zeros())
        self.b_gamma_x = tf.get_variable(dtype = tf.float32, shape = [input_size], initializer= tf.keras.initializers.Zeros())

        self.W_gamma_h = tf.get_variable(dtype = tf.float32, shape = [input_size, hidden_size], initializer= tf.initializers.random_normal(0, 0.02))
        self.b_gamma_h = tf.get_variable(dtype = tf.float32, shape = [hidden_size], initializer= tf.keras.initializers.Zeros())
